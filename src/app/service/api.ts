...
export class Api {
  ...
  getCategoryById(id: string): Observable<any> {
    return this.http.get(`${Api.BASE_URL}/categories/${id}`, {
      headers: this.getHeader(),
    });
  }
  ...
  addSupplier(body: any): Observable<any> {
    return this.http.post(`${Api.BASE_URL}/suppliers/add`, body, {
      headers: this.getHeader(),
    });
  }

  getAllSuppliers(): Observable<any> {
    return this.http.get(`${Api.BASE_URL}/suppliers/all`, {
      headers: this.getHeader(),
    });
  }

  getSupplierById(id: string): Observable<any> {
    return this.http.get(`${Api.BASE_URL}/suppliers/${id}`, {
      headers: this.getHeader(),
    });
  }
  ...
  updateSupplier(id: string, body: any): Observable<any> {
    return this.http.put(
      `${Api.BASE_URL}/suppliers/update/${id}`,
      body,
      {
        headers: this.getHeader(),
      }
  ...
  deleteSupplier(id: string): Observable<any> {
    return this.http.delete(`${Api.BASE_URL}/suppliers/delete/${id}`, {
      headers: this.getHeader(),
    });
  }
  ...
  addProduct(formData: any): Observable<any> {
    return this.http.post(`${Api.BASE_URL}/products/add`, formData, {
      headers: this.getHeader(),
    });
  }

  updateProduct(formData: any): Observable<any> {
    return this.http.put(`${Api.BASE_URL}/products/update`, formData, {
      headers: this.getHeader(),
    });
  }
  ...
  purchaseProduct(body: any): Observable<any> {
    return this.http.post(
      `${Api.BASE_URL}/transactions/purchase`,
      body,
      {
        headers: this.getHeader(),
      }
  ...
  sellProduct(body: any): Observable<any> {
    return this.http.post(`${Api.BASE_URL}/transactions/sell`, body, {
      headers: this.getHeader(),
    });
  }

  getAllTransactions(searchText: string): Observable<any> {
    return this.http.get(`${Api.BASE_URL}/transactions/all`, {
  ...
  getTransactionById(id: string): Observable<any> {
    return this.http.get(`${Api.BASE_URL}/transactions/${id}`, {
      headers: this.getHeader(),
    });
  }
  ...
  updateTransactionStatus(id: string, status: string): Observable<any> {
    return this.http.put(`${Api.BASE_URL}/transactions/update/${id}`, JSON.stringify(status), {
  ...
  getTransactionsByMonthAndYear(month: number, year: number): Observable<any> {
    return this.http.get(`${Api.BASE_URL}/transactions/by-month-year`, {
      headers: this.getHeader(),
      params: {
        month: month,
        year: year,
